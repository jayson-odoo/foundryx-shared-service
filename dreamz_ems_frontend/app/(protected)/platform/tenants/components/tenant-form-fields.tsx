 ...
 * keeps stock Dreamz branding (the console IS the product).
 */
    ...
    return (
      <Card>
        <CardContent className="flex flex-col items-center justify-center gap-2 py-16 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            {tenant
              ? 'The platform console keeps stock Dreamz branding — tenant branding applies to customer tenants only.'

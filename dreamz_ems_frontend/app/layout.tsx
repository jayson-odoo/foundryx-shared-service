...
// Inter = body/UI font; Poppins = Dreamz display font (headings, brand). Both exposed as CSS vars.
 ...
 * its name + icon; everything else = Dreamz defaults. BrandingProvider keeps
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: {
      template: '%s | Dreamz EMS',
      default: 'Dreamz EMS', // a default is required when creating a template
    },
  };
}
...
export default async function RootLayout({
  ...
  // loads before any content renders — no flash of Dreamz orange on branded
  // tenants. First in <body>: a body stylesheet blocks rendering of the
  // content AFTER it and cascades after the bundled dreamz-tokens.css, so

...
export interface BrandedLayoutProps {
  children: ReactNode;
  /** Server-resolved branding (auth layout) — first paint, no Dreamz flash. */
 ...
 * Dreamz defaults; panel color follows the tenant's `--dreamz-primary` override.
 * Branded tenant without a logo shows its NAME (never the Dreamz wordmark —

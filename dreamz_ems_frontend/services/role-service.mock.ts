...
const POOL: PoolUser[] = [
  ...
  { id: 'usr-003', name: 'Aaron Tan', email: 'aaron.tan@dreamz.test', status: 'ACTIVE' },
  { id: 'usr-004', name: 'Bella Lim', email: 'bella.lim@dreamz.test', status: 'INACTIVE' },
  { id: 'usr-005', name: 'Caleb Wong', email: 'caleb.wong@dreamz.test', status: 'ACTIVE' },
  { id: 'usr-006', name: 'Dahlia Rahman', email: 'dahlia.rahman@dreamz.test', status: 'BLOCKED' },
  { id: 'usr-007', name: 'Elias Kaur', email: 'elias.kaur@dreamz.test', status: 'ACTIVE' },
  { id: 'usr-008', name: 'Farah Singh', email: 'farah.singh@dreamz.test', status: 'INVITED' },
  { id: 'usr-009', name: 'Gavin Lee', email: 'gavin.lee@dreamz.test', status: 'ACTIVE' },
  { id: 'usr-010', name: 'Hana Chen', email: 'hana.chen@dreamz.test', status: 'ACTIVE' },
];

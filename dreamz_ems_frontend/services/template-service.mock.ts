...
const CONTEXTS: TemplateContext[] = [
  {
    ...
    facts: [
      ...
      { key: 'resetLink', label: 'Reset link', sample: 'https://acme.dreamzems.com/change-password?token=sample' },
  ...
  },
  {
    ...
    facts: [
      ...
      { key: 'tenant.name', label: 'Tenant name', sample: 'Acme Events' },
      { key: 'inviteLink', label: 'Invitation link', sample: 'https://acme.dreamzems.com/change-password?token=sample' },
    ],
  ...
  },
  {
    ...
    facts: [
      ...
      { key: 'approveLink', label: 'Approve link', sample: 'https://acme.dreamzems.com/approve-email-change?token=sample' },
    ],
  ...
  },
  {
    ...
    facts: [
      { key: 'recipient.firstName', label: 'Recipient first name', sample: 'Alex' },
      { key: 'verifyLink', label: 'Verify link', sample: 'https://acme.dreamzems.com/verify-email-change?token=sample' },
    ],
  ...
  },
  {
    ...
    facts: [
      ...
      { key: 'signinLink', label: 'Sign-in link', sample: 'https://acme.dreamzems.com/signin' },
    ],

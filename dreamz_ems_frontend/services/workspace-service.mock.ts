...
const CANDIDATES: MemberCandidate[] = [
  { userId: 'usr-001', name: 'Aaron Tan', email: 'aaron.tan@dreamz.test', status: 'ACTIVE' },
  { userId: 'usr-002', name: 'Bella Lim', email: 'bella.lim@dreamz.test', status: 'ACTIVE' },
  { userId: 'usr-003', name: 'Caleb Wong', email: 'caleb.wong@dreamz.test', status: 'INACTIVE' },
  { userId: 'usr-004', name: 'Dahlia Rahman', email: 'dahlia.rahman@dreamz.test', status: 'ACTIVE' },
  { userId: 'usr-005', name: 'Elias Kaur', email: 'elias.kaur@dreamz.test', status: 'ACTIVE' },
  { userId: 'usr-006', name: 'Farah Singh', email: 'farah.singh@dreamz.test', status: 'ACTIVE' },
  { userId: 'usr-007', name: 'Gavin Lee', email: 'gavin.lee@dreamz.test', status: 'BLOCKED' },
  { userId: 'usr-008', name: 'Hana Chen', email: 'hana.chen@dreamz.test', status: 'ACTIVE' },
];

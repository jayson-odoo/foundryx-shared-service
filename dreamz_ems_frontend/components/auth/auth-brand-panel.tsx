...
export interface AuthBrandPanelProps {
  ...
  tagline?: string | null;
  /**
   * Wordmark logo: /public path or full/data URL. `undefined` = Dreamz default;
   * `null` = no logo — the panel shows `brandName` instead (a branded tenant
   * must NEVER fall back to the Dreamz wordmark — white-label rule).
   */
  logoSrc?: string | null;
...
/**
 * Brand panel — the solid-primary left side of auth screens. Dreamz by
...
export function AuthBrandPanel({
  ...
  logoSrc = '/media/dreamz/dreamz-logo.png',
  brandName,
  illustrationSrc = '/media/dreamz/auth-illustration.svg',
  className,
}: AuthBrandPanelProps) {
  return (
    <div

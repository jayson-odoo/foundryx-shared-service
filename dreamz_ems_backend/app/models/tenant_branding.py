...
over the Dreamz defaults. No row = stock branding. ``version`` bumps on every
...
class TenantBranding(Base):
    ...
    # back to the tenant name (never the Dreamz product name — white-label).
    ...
    # diff vs the Dreamz defaults. none_as_null: Python None must store SQL

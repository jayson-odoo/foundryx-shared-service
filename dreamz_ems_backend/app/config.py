...
class Settings(BaseSettings):
    ...
    platform_smtp_from_name: str = "Dreamz EMS"
    ...
    # Meta app (Dreamz = Tech Provider). Embedded Signup exchanges the code
    ...
    meta_webhook_verify_token: str = "dreamz-omnichannel-verify"

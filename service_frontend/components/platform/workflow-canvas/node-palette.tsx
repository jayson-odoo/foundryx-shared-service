 ...
 * drivable by scripted browser automation's mouse-event dragTo -
 * template-engine lesson); drag is the nicety. A trigger is disabled once one
 * exists (one trigger per workflow, D2).
 */

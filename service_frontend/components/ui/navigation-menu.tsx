  ...
  return (
    <NavigationMenuPrimitive.Indicator
      ...
      className={cn(
        ...
        // the shared named z-scale steps (config.reui.css). The bare-numeric `z-1`
        // utility (Tailwind v4, no brackets) stays out of the `z-[N]` vocabulary the
        // literal sweep bans (T1 fix round 1 finding 7 widens that guard to also
        // catch a raw zIndex inline style, which this used to be).

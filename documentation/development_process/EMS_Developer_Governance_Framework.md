...
Because the Dreamz EMS is designed as a Platform-as-a-Service (PaaS) with an internal App Store, strict development governance is mandatory. Any future developer (internal hires or third-party agencies) building a custom module MUST adhere to this framework. 

...
def test_manifest_version_and_model_shape(session_factory):
    ...
    # 0.9.0, plan 34 S1 (A7b) to 0.10.0, review round 2 (N-new-4, no schema
    # change) to 0.10.1 - this test pins "the CURRENT manifest version", not
    # a fixed string (updated the same way every prior version bump updated
    # it before).
